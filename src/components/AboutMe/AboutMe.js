                ...
                <div className="container mt-6">
                    <div className="columns">
                        <div className="column">
                            ...
                            <p className={"block"}>
                                I really love programming (I started since I was 12 yo), I'm a Javascript lover but I've tried many technologies. I like to look up for the technology that fits better for every project.
                            </p>
                            <p className="block">
